                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>Rp <?php echo number_format($data_layanan['harga_reseller'],0,',','.'); ?></td>
                                    <td>Rp <?php echo number_format($data_layanan['harga_api'],0,',','.'); ?></td>
                                    <td><small><?php echo $data_layanan['note']; ?></small></td>
                                    <td><span class="badge badge-glow badge-<?php echo $label; ?>"><i class="<?php echo $icon; ?>"></i> <?php echo $data_layanan['status']; ?></span></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
