...
function status($s) {
	...
	$columns = array(
		...
		array( 'db' => 'target',  'dt' => 3, 'formatter' => function($i) {
			return 
			"
		<td style=\"min-width: 180px;\"><div class=\"input-group\"><input id=\"input-".$i."\" type=\"text\" value=\"".$i."\" class=\"form-control form-control-sm\" readonly=\"\">
		<button onclick=\"salin('input-".$i."');\" class=\"btn btn-primary btn-sm\" style=\"border-top-left-radius: 0;border-bottom-left-radius: 0;\"><i class=\"fa fa-copy\"></i></button>
                        </div></td>
			";
		}),  
