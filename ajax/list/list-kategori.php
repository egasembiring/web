...
function status($s) {
    if ($s === "Aktif") {
        return '<span class="text-success"><i class="mdi mdi-checkbox-marked-circle-outline"></i> Normal</span>';
    } else {
        return '<span class="text-danger"><i class="mdi mdi-close-circle-outline"></i> Gangguan</span>';
           }
    }
	?>
                    ...
                    <div class="table-responsive">
                                    <table class="table table-bordered table-striped zero-configuration mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" colspan="4" style="vertical-align:middle">Harga</th>
                                                <th class="text-center" rowspan="2" style="vertical-align:middle">Status</th>
                                            </tr>
                                            <tr>
                                                <th class="text-center">Basic</th>
                                                <th class="text-center">API/Ress</th>
                                                <th class="text-center">Premium</th>
                                                <th class="text-center">H2H&nbsp;Special</th>
                                            </tr>
                                        </thead>
                            <tbody>
                            <?php
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><span class="badge badge-glow badge-primary">Rp <?php echo number_format($data_layanan['harga'],0,',','.'); ?></span></td>                                   
                                    <td><span class="badge badge-glow badge-warning">Rp <?php echo number_format($data_layanan['harga_api'],0,',','.'); ?></span></td>
                                    <td><span class="badge badge-glow badge-info">Rp <?php echo number_format($data_layanan['harga_premium'],0,',','.'); ?></span></td>
                                    <td><span class="badge badge-glow badge-success">Rp <?php echo number_format($data_layanan['harga_h2h'],0,',','.'); ?></span></td>
