...
if (isset($_POST['delete'])) {
	...
	if (!$post_id) {
		$_SESSION['alert'] = ['danger', 'Failed!', 'Masih ada form kosong.'];
                ...
                $delete_news = $db->query("DELETE FROM information WHERE id = '{$post_id}'");
                if ($delete_news === true) {
            ...
            <div class="card overflow-hidden">
                ...
                <div class="card-body card-dashboard">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="NaaAdd-tab" data-toggle="tab" href="#NaaAdd" aria-controls="NaaAdd" role="tab" aria-selected="false">Konten</a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane" id="NaaAdd" aria-labelledby="NaaAdd-tab" role="tabpanel">
                            <form method="POST">
                                ...
                                <div class="form-group text-right">
                                    ...
                                    <button type="submit" name="add" class="btn btn-primary waves-effect waves-light">Tambah</button>
                                </div>
                            </form>
                        </div>
                    </div>
