...
if (isset($_POST['edit_keuntungan'])) {
	...
	$post_reff = $db->real_escape_string(e(@$_POST['reff']));
        $post_bankfee = $db->real_escape_string(e(@$_POST['bankfee']));
	...
	if (!$post_code) {
		$_SESSION['alert'] = ['danger', 'Failed!', 'Masih ada form kosong.'];
	        ...
	        $edit_profit = $db->query("UPDATE keuntungan SET web = '{$post_web}', api = '{$post_api}', reff = '{$post_reff}', bankfee = '{$post_bankfee}' WHERE code = '{$post_code}'");
	        if ($edit_profit === true) {
                ...
                <div class="card-body card-dashboard">
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?= number_format($data_k['reff'],0,',','.'); ?></td>
                                <td><?= number_format($data_k['bankfee'],0,',','.'); ?></td>
                                <td>
