...
<div class="form-group">
        <label>Code</label>
        <input type="text" class="form-control" placeholder="DANAM10" name="code">
    </div>
<div class="form-group">
        <label>Layanan</label>
    ...
    <div class="form-group">
        <label>Harga API</label>
        <input type="number" class="form-control" name="harga_api">
    </div>
    <div class="form-group">
        <label>Harga Premium/K</label>
        <input type="number" class="form-control" name="harga_premium">
    </div>
    <div class="form-group">
        <label>Harga H2H/K</label>
        <input type="number" class="form-control" name="harga_h2h">
    </div>
    <div class="form-group">
        <label>Profit</label>
