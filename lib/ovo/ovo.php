...
class Ovo
{
    ...
    */
    ...
    {
        //&productType=001
        return self::request(self::BASE_API . '/wallet/transaction/last?limit=' . $limit . '&transaction_type=TOPUP%20CASH&transaction_type=INCOMING%20TRANSFER', false, $this->headers());
    ...
    */
    ...
    {
        return self::request(self::AGW_API . "/payment/orders/v1/list?limit=$limit&page=$page&transaction_type=TOPUP%20CASH&transaction_type=INCOMING%20TRANSFER", false, $this->headers('Bearer'));
    }
