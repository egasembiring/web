...
class GojekPay
{
    ...
    {
        $this->sessionId = '8FB5ED6E-322B-407C-BC88-52FF696B8AFA'; // generated from self::uuidv4();
        $this->uniqueId  = 'FCEEC9AF-564D-4599-99E8-F042C7B4DF3F'; // generated from self::uuidv4();
        if ($authToken) {
