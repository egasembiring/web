...
<section id="dashboard-ecommerce">
         <div class="row match-height">
            ...
            <div class="card">
                 <div class="card-body">
                    <h4 class="m-t-0 text-uppercase header-title"><i class=""></i>SYARAT KETENTUAN</h4><hr><br>
<p>Welcome to <b><?= config('web', 'title_web') ?>!</b></p>
<p>These terms and conditions outline the rules and regulations for the use of
CV. <?= config('web', 'title_web') ?>'s
Website, located at <?= base_url() ?></p>
<p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
<?= config('web', 'title_web') ?> if you do not agree to take all of the terms and conditions stated on
this page.</p>
...
<p>We employ the use of cookies. By accessing <?= config('web', 'title_web') ?>, you agreed to use cookies
in agreement with
the CV. <?= config('web', 'title_web') ?>'s Privacy Policy. </p>
...
<p>Unless otherwise stated, CV. <?= config('web', 'title_web') ?> and/or its licensors own the intellectual
property rights
for all material on <?= config('web', 'title_web') ?>. All intellectual property rights are reserved.
You may access this
from <?= config('web', 'title_web') ?> for your own personal use subjected to restrictions set in these
terms and
conditions.</p>
<p>You must not:</p>
<ul>
<li>Republish material from <?= config('web', 'title_web') ?></li>
<li>Sell, rent or sub-license material from <?= config('web', 'title_web') ?></li>
<li>Reproduce, duplicate or copy material from <?= config('web', 'title_web') ?></li>
<li>Redistribute content from <?= config('web', 'title_web') ?></li>
</ul>
...
information in certain areas of the website. CV. <?= config('web', 'title_web') ?> does not filter,
edit, publish or
review Comments prior to their presence on the website. Comments do not reflect the views and
opinions of CV. <?= config('web', 'title_web') ?>,its agents and/or affiliates. Comments reflect the
views and opinions of
the person who post their views and opinions. To the extent permitted by applicable laws,
CV. <?= config('web', 'title_web') ?> shall not be liable for the Comments or for any liability,
damages or expenses
caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
Comments on this website.</p>
<p>CV. <?= config('web', 'title_web') ?> reserves the right to monitor all Comments and to remove any
...
<p>You hereby grant CV. <?= config('web', 'title_web') ?> a non-exclusive license to use, reproduce, edit
...
hyperlink compensates the absence of CV. <?= config('web', 'title_web') ?>; and (d) the link is in the
context of general
...
our website, you must inform us by sending an e-mail to CV. <?= config('web', 'title_web') ?>. Please
include your name,
...
<p>No use of CV. <?= config('web', 'title_web') ?>'s logo or other artwork will be allowed for linking
absent a trademark
license agreement.</p>
...
<p>Please read <a href="#">Privacy Policy</a></p>
